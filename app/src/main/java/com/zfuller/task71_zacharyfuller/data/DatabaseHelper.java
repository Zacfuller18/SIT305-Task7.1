package com.zfuller.task71_zacharyfuller.data;
...
import com.zfuller.task71_zacharyfuller.util.Util;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String CREATE_USER_TABLE = "CREATE TABLE " + Util.TABLE_NAME + "(" + Util.ITEM_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + Util.TYPE + " TEXT," + Util.NAME + " TEXT," + Util.PHONE + " TEXT," + Util.DESC + " TEXT," + Util.DATE + " TEXT," + Util.LOCATION + " TEXT" + ")";
